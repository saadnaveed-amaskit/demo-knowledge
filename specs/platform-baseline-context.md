...
- **Spec:** `knowledge/specs/001-platform-baseline/spec.md` (exists — `status: Draft`)
- **Plan:** `knowledge/specs/001-platform-baseline/plan.md` (not yet created — via `/create-platform-plan`)
